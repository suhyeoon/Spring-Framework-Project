...
<div id="hotelOutFmapPop" style="display: block;"><div class="popLayer popLayerHotelMap" tabindex="-1" style="top: 770px; left: 669px;">
	<div class="popHead">
		<h2 class="tit"><img src="<%=request.getContextPath()%>/images/ko/jeju/activities/hmOutMapTit.jpg" alt="게임존 위치"></h2>
		<div class="btn"><a class="btnClose" href="" onclick="closePopup(); return false;"></a></div>
	</div>
	<div class="popCtn">
		

<img alt="야외 시설 Floor Map" src="<%=request.getContextPath()%>/images/contents/activ/PLA/R0000000AAQ8_KR.jpg">
