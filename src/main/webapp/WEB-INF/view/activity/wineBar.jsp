...
function popLayerShow(areaId, classId){
	...
	<div class="location">
		<p class="list"><span class="crPosit">현재 페이지 위치 : </span> &gt; 액티비티 &gt; <strong>와인바</strong></p>
	</div>
...
<img alt="와인바 사진" src="${pageContext.request.contextPath}/images/contents/activ/WINE/R0000000D2SI_KR.jpg">
...
<img alt="와인바 사진 사진 1" src="${pageContext.request.contextPath}/images/contents/activ/WINE/R0000000D530_KR.jpg">
...
<img src="${pageContext.request.contextPath}/images/contents/activ/WINE/R0000000EVY6_KR.jpg" alt="실내 체육관(하단 내용 참조)">
								...
								<div class="fiTsSwrap">
									<div class="pic">
	<span class="Mr18">
	<img alt="와인바 사진 2" src="${pageContext.request.contextPath}/images/contents/activ/WINE/R0000000D53C_KR.jpg">
	</span>										
	<span class="Mr18">
	<img alt="와인바 사진 3" src="${pageContext.request.contextPath}/images/contents/activ/WINE/R0000000D537_KR.jpg">
	</span>
	<img alt="와인바 사진 4" src="${pageContext.request.contextPath}/images/contents/activ/WINE/R0000000FAB7_KR.jpg">
