...
<tr>
	<td class="title">이미지1</td>
	
	<td colspan=3>
	<c:if test="${board.image1 ne null}">
	<img src="<%=request.getContextPath()%>/images/review/${board.image1}" width="300" height="300"/>
	</c:if>
	</td>
</tr>
<tr>
	<td class="title">이미지2</td>
	<td colspan=3>
	<c:if test="${board.image2 ne null}">
	<img src="<%=request.getContextPath()%>/images/review/${board.image2}" width="300" height="300"/>
	</c:if>
	</td>
</tr>
<tr>
	<td class="title">이미지3</td>
	<td colspan=3>
	<c:if test="${board.image3 ne null}">
	<img src="<%=request.getContextPath()%>/images/review/${board.image3}" width="300" height="300"/>
	</c:if>
	</td>
</tr>
<tr>
