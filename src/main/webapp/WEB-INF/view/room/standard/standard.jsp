...
<script type="text/javascript">
	function openAccmoMapPopup() {
		var windowW = 600; // 창의 가로 길이
		var windowH = 900; // 창의 세로 길이

		var left = Math.ceil((window.screen.width - windowW) / 2);
		var top = Math.ceil((window.screen.height - windowH) / 2);
		window.open("${pageContext.request.contextPath}/search/popup_standard_room.jsp", "popup_map", "top="
				+ top + ",left=" + left
...
td,th,p,textarea{margin:0; padding:0; color:#101010; }
.icoBooking {
    position: relative;
    width: 15px;
    height: 12px;
							...
							<div class="ctnRetreat">
								...
								<div class="headTit">
									<h4 class="tit" align="left">
										<img alt="스탠다드"
											src="<%=request.getContextPath()%>/images/accommodation/standard/R00000009TS6_KR.gif">
									</h4>
								</div>
								...
								<div class="flexslider">
									<ul class="slides">
										<li
											data-thumb="<%=request.getContextPath()%>/images/accommodation/standard/R000000081YL_KR.jpg">
											<img
											src="<%=request.getContextPath()%>/images/accommodation/standard/R000000081YJ_KR.jpg" />
										</li>
										<li
											data-thumb="<%=request.getContextPath()%>/images/accommodation/standard/R00000000FLB_KR.jpg">
											<img
											src="<%=request.getContextPath()%>/images/accommodation/standard/R00000000I70_EN.jpg" />
										</li>
										<li
											data-thumb="<%=request.getContextPath()%>/images/accommodation/standard/R00000000SXS_KR.jpg">
											<img
											src="<%=request.getContextPath()%>/images/accommodation/standard/R00000000SYM_EN.jpg" />
										</li>
										<li
											data-thumb="<%=request.getContextPath()%>/images/accommodation/standard/R00000000SXV_KR.jpg">
											<img
											src="<%=request.getContextPath()%>/images/accommodation/standard/R00000000SYP_EN.jpg" />
										</li>
									</ul>
								</div>
								...
								<!--  Syntax Highlighter -->
  <script type="text/javascript" src="<%=request.getContextPath()%>/js/ex/shCore.js"></script>
  <script type="text/javascript" src="<%=request.getContextPath()%>/js/ex/shBrushXml.js"></script>
  <script type="text/javascript" src="<%=request.getContextPath()%>/js/ex/shBrushJScript.js"></script>

   <!-- Optional FlexSlider Additions -->
  <script src="<%=request.getContextPath()%>/js/ex/jquery.easing.js"></script>
  <script src="<%=request.getContextPath()%>/js/ex/jquery.mousewheel.js"></script>
  <script defer src="<%=request.getContextPath()%>/js/ex/demo.js"></script>
								...
								<div class="btmCon">
									<div class="leftArea">
										<div class="topTxtwrap">
											<div class="topTxt">
												<img
													src="<%=request.getContextPath()%>/images/accommodation/standard/R0000000EFJM_KR.jpg"
													alt="스탠다드룸 소개(하단 내용 참조)">
												<div class="hidden">
													<p>제주의 푸른 하늘과 안락한 산의 풍경이 펼쳐져 있는 스탠다드 룸</p>
													<p>제주신라호텔의 고품격 서비스를 만나 볼 수 있는 가장 기본 객실로 1 ~ 5층에 위치하고
														있습니다.</p>
													<p>문의전화 :&nbsp;1588-1142 (대표)</p>
													<p>기본 타입 룸</p>
													<p>스튜디오 타입의 파스텔 톤 객실에 휴식을 취할 수 있는 테이블과 체어, 그리도 라탄 타입의
														아늑한 체어를 완비한 제주신라의 가장 기본적인 룸입니다.</p>
													<dl>
														<dt>위치</dt>
														<dd>1 ~ 5층</dd>
														<dt>전망</dt>
									...
									<div class="rightArea">
										<ul class="btnSet">
											<li class="first"><a id="accmoMapBtn"
												...
												onclick="openAccmoMapPopup(); return false;"><img
