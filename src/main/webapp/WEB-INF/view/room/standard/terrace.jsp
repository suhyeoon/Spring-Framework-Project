...
<title>standard | terrace</title>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-3.2.0.min.js"></script>
<script type="text/javascript">
	function openTerraceMapPopup() {
		var windowW = 600; // 창의 가로 길이
		var windowH = 900; // 창의 세로 길이

		var left = Math.ceil((window.screen.width - windowW) / 2);
		var top = Math.ceil((window.screen.height - windowH) / 2);
		window.open("${pageContext.request.contextPath}/search/popup_terrace_room.jsp", "popup_terrace_map", "top="
				+ top + ",left=" + left
							...
							<div class="ctnRetreat">
								...
								<div class="headTit">
									<h4 class="tit" align="left">
										<img alt="테라스"
											src="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R00000009TU6_KR.gif">
									</h4>
								</div>
								
								<div class="flexslider">
									<ul class="slides">
										<li data-thumb="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R00000001JNR_KR.jpg">
											<img src="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R00000001JNP_KR.jpg" />
										</li>
										<li data-thumb="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R00000001JNW_KR.jpg">
											<img src="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R00000001JNU_KR.jpg" />
										</li>
										<li data-thumb="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R00000001JO1_KR.jpg">
											<img src="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R00000001JNZ_KR.jpg" />
										</li>
										<li data-thumb="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R00000001JO6_KR.jpg">
											<img src="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R00000001JO4_KR.jpg" />
										</li>
									</ul>
								</div>
								...
								<div class="btmCon">
									<div class="leftArea">
										<div class="topTxtwrap">
											<div class="topTxt">
												<img
													src="<%=request.getContextPath()%>/images/accommodation/standard/terrace/R0000000EFM1_KR.jpg"
													alt="테라스룸 소개(하단 내용 참조)">												
											</div>
											<div class="btBtm">
									...
									<div class="rightArea">
										<ul class="btnSet">
											<li class="first"><a id="accmoMapBtn"
												href="/jeju/accommodation/viewAccmo.do"
												onclick="openTerraceMapPopup(); return false;"><img
