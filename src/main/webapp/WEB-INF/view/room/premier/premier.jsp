...
<script>
	...
	function openAmenityPopup() {
		...
		var left = Math.ceil((window.screen.width - windowW) / 2);
		var top = Math.ceil((window.screen.height - windowH) / 2);
		window.open("${pageContext.request.contextPath}/search/popup_Amenity.jsp", "popup_Amenity", "top=" + top
				+ ",left=" + left
	...
	<center>
		...
		<div class="demo">
			...
			<div class="item">
				...
				<h4 class="tit">
				<img alt="프리미어"
				src="${pageContext.request.contextPath}/images/contents/accmo/PE/R00000009TV6_KR.gif">
				</h4>
				</div>
				<div class="clearfix" style="max-width: 866px;">
				<ul id="image-gallery" class="gallery list-unstyled cS-hidden">
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/thumb/R00000008XI0_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PE/R00000008XHZ_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/thumb/R00000008XI3_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PE/R00000008XI2_KR.jpg">
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/thumb/R000000011V6_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PE/R000000011V4_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/thumb/R00000008XI9_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PE/R00000008XI8_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/thumb/R000000011VB_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PE/R000000011V9_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/thumb/R00000002BUO_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PE/R00000002BUN_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/thumb/R00000002BWL_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PE/R00000002BWJ_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/thumb/R00000002BYG_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PE/R00000002BYE_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/thumb/R000000029KI_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PE/R000000029KG_KR.jpg" />
					</li>
				</ul>
			</div>
				...
				<div class="leftArea">
					<div class="topTxtwrap">
						<div class="topTxt">
							...
							<img
								src="<%=request.getContextPath()%>/images/contents/accmo/PE/R0000000EFNV_KR.jpg"
