...
<script>
	...
	function openDivPopup() {
		...
		window.open("${pageContext.request.contextPath}/search/popup_preSuite_Div.jsp", "popup_preDiv", "top=" + top
				+ ",left=" + left
				+ ",width=600,height=530,resizable=no,scrollbars=yes")
	}
			...
			<div class="item">
				...
				<div class="location">
					<p class="list">
						...
						<strong>프리미어_스위트</strong>
					</p>
				</div>
				<div class="headTit">
				<h4 class="tit">
				<img alt="프리미어 스위트"
				src="${pageContext.request.contextPath}/images/contents/accmo/PE/R00000009U29_KR.gif">
				</h4>
				</div>
				<div class="clearfix" style="max-width: 866px;">
				<ul id="image-gallery" class="gallery list-unstyled cS-hidden">
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/PS/thumb/R000000012GE_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PS/R000000012GC_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/PS/thumb/R000000012GJ_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PS/R000000012GH_KR.jpg">
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/PS/thumb/R00000001JRG_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PS/R00000001JRE_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/PS/thumb/R00000001JRL_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PS/R00000001JRJ_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/PS/thumb/R0000000245L_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PS/R0000000245J_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/PS/thumb/R0000000245Q_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PS/R0000000245O_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/PS/thumb/R000000024E9_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PS/R000000024E7_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/PS/thumb/R000000024EE_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PS/R000000024EC_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/PS/thumb/R0000000CD8G_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/PS/R0000000CD8E_KR.jpg" />
					</li>
				</ul>
			</div>
				...
				<div class="leftArea">
					<div class="topTxtwrap">
						<div class="topTxt">
							...
							<img
								src="<%=request.getContextPath()%>/images/contents/accmo/PE/R0000000EFVP_KR.jpg"
