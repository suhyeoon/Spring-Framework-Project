...
<script>
	...
	function openDivPopup() {
		...
		window.open("${pageContext.request.contextPath}/search/popup_presiSuite_Div.jsp", "popup_presiDiv", "top=" + top
				+ ",left=" + left
			...
			<div class="item">
				...
				<div class="location">
					<p class="list">
						...
						<strong>프레지덴셜_스위트</strong>
					</p>
				</div>
				<div class="headTit">
				<h4 class="tit">
				<img alt="프레지덴셜 스위트"
				src="${pageContext.request.contextPath}/images/contents/accmo/PE/R00000009U39_KR.gif">
				</h4>
				</div>
				<div class="clearfix" style="max-width: 866px;">
				<ul id="image-gallery" class="gallery list-unstyled cS-hidden">
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/presidential/thumb/R00000000G0Y_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/presidential/R00000000G0W_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/presidential/thumb/R00000000G13_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/presidential/R00000000G11_KR.jpg">
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/presidential/thumb/R00000000G18_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/presidential/R00000000G16_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/presidential/thumb/R00000000SUF_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/presidential/R00000000SUE_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/presidential/thumb/R00000001JPX_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/presidential/R00000001JPV_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/presidential/thumb/R00000001JQ2_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/presidential/R00000001JQ0_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/presidential/thumb/R00000001JQ7_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/presidential/R00000001JQ5_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/presidential/thumb/R00000001JQC_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/presidential/R00000001JQA_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/presidential/thumb/R00000001JQH_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/presidential/R00000001JQF_KR.jpg" />
					</li>
				</ul>
			</div>
			...
			<div class="btmCon">
				<div class="leftArea">
					<div class="topTxtwrap">
						<div class="topTxt">
							<img
								src="<%=request.getContextPath()%>/images/contents/accmo/PE/R0000000EZCY_KR.gif"
