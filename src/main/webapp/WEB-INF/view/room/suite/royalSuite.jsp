...
<script>
	...
	function openDivPopup() {
		...
		window.open("${pageContext.request.contextPath}/search/popup_royalSuite_Div.jsp", "popup_royalDiv", "top=" + top
				+ ",left=" + left
			...
			<div class="item">
				...
				<div class="location">
					<p class="list">
						...
						<strong>로열_스위트</strong>
					</p>
				</div>
				<div class="headTit">
				<h4 class="tit">
				<img alt="로열 스위트"
				src="${pageContext.request.contextPath}/images/contents/accmo/PE/R00000009U09_KR.gif">
				</h4>
				</div>
				<div class="clearfix" style="max-width: 866px;">
				<ul id="image-gallery" class="gallery list-unstyled cS-hidden">
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/RY/thumb/R00000000G00_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/RY/R00000000FZY_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/RY/thumb/R00000000MGC_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/RY/R00000000MGA_KR.jpg">
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/RY/thumb/R00000000MGH_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/RY/R00000000MGF_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/RY/thumb/R00000000MGM_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/RY/R00000000MGK_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/RY/thumb/R00000001JQH_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/RY/R00000001JQF_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/RY/thumb/R00000002C9E_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/RY/R00000002C9C_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/RY/thumb/R000000026A4_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/RY/R000000026A2_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/RY/thumb/R000000026AY_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/RY/R000000026AW_KR.jpg" />
					</li>
					<li
						data-thumb="<%=request.getContextPath()%>/images/contents/accmo/RY/thumb/R000000026BB_KR.jpg">
						<img
						src="<%=request.getContextPath()%>/images/contents/accmo/RY/R000000026B9_KR.jpg" />
					</li>
				</ul>
			</div>
			...
			<div class="btmCon">
				<div class="leftArea">
					<div class="topTxtwrap">
						<div class="topTxt">
							<img
								src="<%=request.getContextPath()%>/images/contents/accmo/PE/R0000000EZC0_KR.gif"
						...
						<div class="btBtm" style="height: 350px;">
