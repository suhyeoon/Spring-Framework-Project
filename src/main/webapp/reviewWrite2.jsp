...
<form:form action="writeTest" name="boardForm" method="post" modelAttribute="writeForm"
	enctype="multipart/form-data" onsubmit="return write2()">
...
<table width="700px" border="3" bordercolor="lightgray" align="center" id="tbl">
		...
		<tr>
			...
			<td colspan="3">
				<div contentEditable="true" id="contentsView" style="width:534px;height:600px;overflow:auto;"></div>
				<textarea style="display:none;" name="contents" id="contents" rows="35" cols="70">${board.contents}</textarea>
				<script>
